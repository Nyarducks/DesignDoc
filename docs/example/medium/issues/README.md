...
them. An issue that gets scheduled becomes a plan
(`docs/plan/NNNN-<change>/`) or a code change; set `resolved_by:` in its
frontmatter. *(Fictional example — the Freightloop project.)*
